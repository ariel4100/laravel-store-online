...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <form role="form" action="{{route('productos.update',$pro->id_product)}}" method="POST" enctype="multipart/form-data">
                <div class="col-md-8">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="name_pro" value="{{ $pro->name_pro }}" class="form-control" placeholder="Nombre del producto">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="price_pro" value="{{ $pro->price_pro }}" class="form-control mb-4" placeholder="Precio">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="quantity_pro" value="{{ $pro->quantity_pro }}" class="form-control mb-4" placeholder="cantidad">
                            </div>
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h4>Editar Variantes del Producto</h4>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <label>Talles</label>
