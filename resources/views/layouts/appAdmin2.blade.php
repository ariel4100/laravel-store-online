                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ route('item') }}" target="_blank" class="btn btn-default btn-flat">Tu Tienda</a>
                                </div>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{ route('categorias.index') }}"><i class="fa fa-link"></i> <span>Categorias</span></a></li>
