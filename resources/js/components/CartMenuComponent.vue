            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" @click="addToCart(addProduct)">Agregar al Carrito</button>
                    </div>
                </div>
            </div>
        </div>
        <span class="btn btn-warning btn-circle" v-if="hasProduct()">
           {{ cartProduct.length }}
        </span>
    </section>
</template>
    ...
    export default {
        ...
        methods: {
          getItems(){
            ...
            hasProduct() {
                return this.cartProduct.length > 0;
            },
        },
    }
</script>
